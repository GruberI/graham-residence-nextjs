        ...
        {option.values.map((value) => {
          ...
          return (
            <button
              ...
              className={clsx(
                "flex min-w-[48px] items-center justify-center rounded-full border bg-neutral-100 px-2 py-1 text-xs sm:text-sm dark:border-neutral-800 dark:bg-neutral-900",
                {

        ...
        <div className="text-gray-700">
          <div className="text-sm leading-6 text-gray-700">
            <p>
              ...
              SOFTWARE, TOOLS, FEATURES, OR FUNCTIONALITIES (COLLECTIVELY, THE
              “PLATFORM”), AS WELL AS ANY SERVICES PROVIDED ON OR THROUGH THE
              PLATFORM (“SERVICES”). BY CLICKING TO ACCEPT AND/OR USING THE
              PLATFORM OR SERVICES, YOU AGREE TO BE BOUND BY THESE TERMS AND ALL
              OF THE TERMS INCORPORATED HEREIN BY REFERENCE. IF YOU DO NOT AGREE
              TO THESE TERMS, YOU MAY NOT ACCESS THE PLATFORM, ANY SERVICES
              AVAILABLE THROUGH THE PLATFORM OR ANY INFORMATION CONTAINED ON THE
            ...
            <p>
              By using this Platform, you represent, acknowledge and agree that
              you are at least 18 years of age, or if you are under 18 years of
              age but are at least 13 years old (a “Minor”), that you are using
              the Platform with the consent of your parent or legal guardian and
              that you have received your parent’s or legal guardian’s
              ...
              license, you have no other rights in the Platform or any Materials
              and you may not modify, edit, copy, reproduce, create derivative
              works of, reverse engineer, alter, enhance or in any way exploit
              any of the Platform or Materials in any manner. If you breach any
              of these Terms, the above license will terminate automatically and
          ...
          <div className="text-sm leading-6 text-gray-700">
            <p className="pt-4">
              <strong className="font-semibold text-gray-900">Fees:</strong>
            </p>
            <p className="pt-6 text-sm">
              In consideration of any transactions made on the Platform, you
              will pay (or caused to be paid) us the transaction fees, payment
              transfer fees (if applicable), taxes (other than taxes on our net
              income) associated with the transaction and will not deduct any
              such amounts from the amounts paid to us. We are not responsible
              for determining, withholding, collecting, reporting, or remitting
              the taxes that apply to your transactions. All amounts owed
              hereunder will be paid in US Dollars. We reserve the right to
              change fees at any time, and do not provide price protection in
              the event of promotions or fee decreases.
            </p>

            <p className="pt-6 text-sm">
              Unless indicated otherwise on the Platform, you are solely
              responsible for paying all the fees set forth on the Platform. We
              will not advance nor fund any fees on your behalf, nor shall we be
              responsible should the fees paid are insufficient or excessive. We
              may suspend or terminate your access to our Services and the
              Platform if your payment is late and/or your offered payment
              method (e.g., credit card or PayPal account) cannot be processed.
              We may make third-party products or services available via the
              Platform or otherwise through the Services. Such third parties may
              charge fees for their services. We are not responsible for the
              fees charged by any such third parties.
            </p>
            ...
            <p className="pt-4 text-sm">
              Certain Materials that are not Submissions (defined herein) may be
              provided by third-party licensors and service providers through
              the Service or Platform (“Third-Party Content”) where separate and
              additional terms govern the use of that Third-Party Content. We do
              not make any representations or warranties about the Third-Party
              Content accessible through the Service or Platform, and your
              access to and use of such Third-Party Content is at your own risk.
            </p>
            ...
            <p className="pt-4 text-sm">
              ...
              that provide question-and-answer forum functionality
              (collectively, “Third-Party Platforms”). Certain areas of the
              Platform may allow you to interact and/or conduct transactions
              with such Third-Party Platforms, and, if applicable, allow you to
              configure your privacy settings in your Third-Party Platform
              account to permit your activities on this Platform to be shared
              with your contacts in your Third-Party Platform account and, in
              ...
              services, links displayed and/or any other activities conducted on
              or through such Third-Party Platforms. We are not responsible for
              any of the Third-Party Platforms or the products, services, or
              content available through any of them. Thus, we do not endorse or
              make any representations about such Third-Party Platforms, any
              information, software, products, services, or materials found
              ...
              AND/OR THIRD-PARTY DEALINGS OR COMMUNICATIONS, OR FOR ANY HARM
              RELATED THERETO, OR FOR ANY DAMAGES OR LOSS CAUSED OR ALLEGED TO
              BE CAUSED BY OR IN CONNECTION WITH YOUR USE OR RELIANCE ON THE
            ...
            <p className="pt-4 text-sm">
              You are responsible for the information, opinions, messages,
              comments, photos, videos, graphics, sounds and other content or
              material that you submit, upload, post or otherwise make available
              on or through the Platform and through the Services available in
              connection with this Platform (each a “Submission”). You may not
              upload, post or otherwise make available on this Platform any
              material protected by copyright, trademark, or any other
              proprietary right without the express permission of the owner of
              such copyright, trademark or other proprietary right owned by a
              third-party, and the burden of determining whether any material is
              ...
              publicity rights or any other harm resulting from any Submission
              that you make. You have full responsibility for each Submission
              you make, including its legality, reliability and appropriateness.
              ...
              works, publish, transmit and distribute each of your Submissions,
              or any portion thereof, in any form, medium or distribution method
              now known or hereafter existing, known or developed, and authorize
              others to use the Submissions. We may modify or adapt your
              Submissions in order to transmit, display or distribute them over
            ...
            >
              ...
              <li className="flex gap-x-3">
                <CheckCircleIcon
                  ...
                  aria-hidden="true"
                />
                <span>Discuss or incite illegal activity.</span>
              </li>
              <li className="flex gap-x-3">
                <CheckCircleIcon
                  className="mt-1 h-5 w-5 flex-none text-orange-800"
              ...
              <li className="flex gap-x-3">
                <CheckCircleIcon
                  ...
                  aria-hidden="true"
                />
                <span>Post anything clearly false or misleading.</span>
              </li>
              <li className="flex gap-x-3">
                <CheckCircleIcon
                  className="mt-1 h-5 w-5 flex-none text-orange-800"
              ...
              <li className="flex gap-x-3">
                ...
                <span>
                  ...
                  reputation, provided that the foregoing will not apply to you
                  if applicable law prohibits such limitations and restrictions.
                </span>
              </li>
            </ul>
            ...
            <p className="pt-4 text-sm">
              ...
              on this Platform may violate certain laws and regulations.
            </p>
            <br />
            <p className="pt-4 text-sm">
              ...
              user name and/or password (including without limitation, your
              participation in the posting areas or, your Submissions) violates
              any applicable law or regulation, or the copyrights, trademark
            ...
            <p className="pt-4">
              ...
              OPERABILITY, CONDITION, SYSTEM INTEGRATION, NON-INTERFERENCE,
              WORKMANSHIP, TRUTH, ACCURACY (OF DATA OR ANY OTHER INFORMATION OR
              CONTENT), ABSENCE OF DEFECTS, WHETHER LATENT OR PATENT, OR
              COMPLETENESS OF ANY INFORMATION OR MATERIAL CONTAINED OR PRESENTED
              ON THIS SITE, INCLUDING WITHOUT LIMITATION THE MATERIALS. UNLESS
              OTHERWISE EXPLICITLY STATED, TO THE MAXIMUM EXTENT PERMITTED BY
              APPLICABLE LAW, THE PLATFORM, THE SERVICES, AND MATERIALS, AND ANY
              ...
              ANY ACCESS TO OR USE OF THE PLATFORM, SERVICES, MATERIALS, OR
              THIRD-PARTY CONTENT INCLUDING BUT NOT LIMITED TO ANY LOSS, DAMAGE
              OR CLAIM ARISING FROM: (I) USER ERROR SUCH AS FORGOTTEN PASSWORDS,
              INCORRECTLY CONSTRUCTED TRANSACTIONS, OR MISTYPED ADDRESSES; (II)
              SERVER FAILURE OR DATA LOSS; OR (III) ANY UNAUTHORIZED THIRD PARTY
              ACTIVITIES, INCLUDING WITHOUT LIMITATION THE USE OF VIRUSES,
              PHISHING, BRUTEFORCING OR OTHER MEANS OF ATTACK AGAINST THE
              PLATFORM. ANY WARRANTIES MADE BY US ARE FOR THE BENEFIT OF THE
              USER OF THE PLATFORM ONLY AND NOT FOR THE BENEFIT OF ANY THIRD
              PARTY.
            </p>
            ...
            >
              <li className="flex gap-x-3">
                <CheckCircleIcon
                  ...
                  aria-hidden="true"
                />
                <span>Your access to or use of our Services or Platform;</span>
              </li>
              <li className="flex gap-x-3">
                <CheckCircleIcon
                  className="mt-1 h-5 w-5 flex-none text-orange-800"
              ...
              <li className="flex gap-x-3">
                ...
                />
                <span>
                  Your violation, misappropriation or infringement of any
                  intellectual property, privacy, or other rights of another
                  user;
                </span>
              </li>
              <li className="flex gap-x-3">
              ...
              <li className="flex gap-x-3">
                <CheckCircleIcon
                  ...
                  aria-hidden="true"
                />
                <span>Your conduct in connection with our Services.</span>
              </li>
            </ul>
            ...
            <p className="pt-4">
              ...
              If you use this Platform outside the United States of America, you
              are responsible for following applicable local laws including
              export control regulations. Feedback.
            </p>
            <p>
              ...
              Feedback. Where the foregoing assignment is prohibited by law, you
              hereby grant Us an exclusive, transferable, worldwide,
            ...
            <p className="pt-4">
              <strong className="font-semibold text-gray-900">
                Please read the following (this “Provision”) carefully. It
                affects your rights.
              </strong>
            </p>
            <p className="pt-4">
              ...
              disputes to a neutral third person (or arbitrator) for a binding
              decision. You have the right to opt-out of this Provision (as
              explained below), which means you would retain your right to
            ...
            <p className="pt-2">
              ...
              before a judge or jury, and/or to participate in or be represented
              in a case filed in court by others (including, but not limited to,
              class actions). Except as otherwise provided, entering into these
              Terms constitutes a waiver of your right to litigate claims and
              all opportunity to be heard by a judge or jury. There is no judge
              or jury in arbitration, and court review of an arbitration award
              is limited. The arbitrator must follow these Terms and can award
            ...
            <p className="pt-2">
              ...
              claim for relief, and includes the validity, enforceability or
              scope of this Provision (with the exception of the enforceability
            ...
            <p className="pt-4">
              ...
              shall be commenced as an individual arbitration only, and shall in
              no event be commenced as a class arbitration or a consolidated or
              representative action or arbitration. All issues shall be for the
              arbitrator to decide, including the scope of this Provision. For
              arbitration before AAA, for Disputes of less than $75,000, the
              AAA’s Supplementary Procedures for Consumer-Related Disputes will
              apply; for Disputes involving $75,000 or more, the AAA’s
              Commercial Arbitration Rules will apply. In either instance, the
              AAA’s Optional Rules For Emergency Measures Of Protection shall
              apply. The AAA rules are available at www.adr.org or by calling
              ...
              www.jamsadr.com or by calling 1-800-352-5267. This Provision
              governs in the event it conflicts with the applicable arbitration
              rules. Under no circumstances will class action or representative
              action procedures or rules apply to the arbitration. Because the
              Platform and these Terms concern interstate commerce, the Federal
              ...
              consistent with the FAA and the applicable statute of limitations
              or condition precedent to suit. Arbitration Award – The arbitrator
              may award on an individual basis any relief that would be
              available pursuant to applicable law, and will not have the power
              to award relief to, against or for the benefit of any person who
              is not a party to the proceeding. The arbitrator will make any
              award in writing but need not provide a statement of reasons
              unless requested by a party or if required by applicable law. Such
              award will be final and binding on the parties, except for any
              right of appeal provided by the FAA or other applicable law, and
              ...
              determined by the arbitrator. Class Action Waiver
            </p>
            <p className="pt-2">
              ...
              APPLY TO YOU. Neither you, nor any other user of the Platform can
              be a class representative, class member, or otherwise participate
            ...
            <p className="pt-4">
              ...
              provided below, those rights are waived. Other rights that you
              would have if you went to court, such as the right to appeal and
              to certain types of discovery, may be more limited or may also be
              waived.
            </p>
            ...
            <p className="pt-4">
              <strong className="font-semibold text-gray-900">Language.</strong>
              The Parties hereto have expressly required that these Terms and
              all documents and notices relating thereto be drafted in the
              English language.
            </p>
            ...
            <p className="pt-4">
              ...
              International Sale of Goods and any laws based on the Uniform
              Computer Information Transactions Act (UCITA) shall not apply to
              these Terms. Except for Disputes subject to arbitration as
              described above, any disputes relating to these Terms or this
              Platform will be heard in the courts located in New York County in

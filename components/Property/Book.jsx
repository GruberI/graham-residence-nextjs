export default function Book() {
  return (
    <div
      className="m-auto border-t border-black pt-10 sm:pt-24 pb-0 sm:pb-24 bg-[#f5f5f5] sm:bg-white"
      id="property-book"
    >
      <div className="m-auto max-w-3xl px-4 sm:px-6 lg:max-w-7xl lg:px-8 bg-[#f5f5f5]">
        <div className="grid grid-cols-1 flex items-center gap-y-6 sm:gap-y-16 lg:grid-cols-2">
          <div className="flex items-end flex-col ml-0 sm:ml-20">
            <p className="m-auto mb-2 text-2xl sm:text-3xl text-center mt-6 sm:mt-0">We'd love to see you at </p>

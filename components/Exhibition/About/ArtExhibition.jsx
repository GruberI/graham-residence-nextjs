    ...
    >
      <div className="bg-white">
        <div className="mx-auto max-w-2xl px-4 py-20 sm:px-6 sm:py-26 lg:max-w-7xl lg:px-8">
          ...
          <div>
              <div className="aspect-h-1 aspect-w-1 bg-black-100">
                <img
            ...
            <div>
              <h2 className="text-center mt-2 text-7xl font-thin tracking-wide text-black-900 sm:text-6xl">
                A Quiet Noise
              </h2>

              <div className="mt-10 space-y-10">
                <p className="mt-3 text-base text-black-800 leading-8">
          ...
          <p className="mt-7 text-base text-black-800 leading-8">

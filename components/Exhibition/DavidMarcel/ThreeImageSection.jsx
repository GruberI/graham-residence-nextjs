  ...
  return (
    <div className="three-image-section mx-auto grid grid-rows-1 grid-cols-1 sm:grid-cols-5 grid-flow-col max-w-7xl pt-16">
      <div
        ...
        }  sm:col-span-2 hidden sm:flex flex-col sm:justify-between`}
      >
        <div>
      ...
      <div className="flex flex-col-reverse sm:flex-row  sm:col-span-3 mx-10 sm:mx-auto sm:h-[80%]">
        <div
          className={`${
            imageData.imgThird ? "sm:row-start-2 sm:row-span-2" : ""
          } sm:content-end text-end pl-20 pr-4 justify-center mt-6 sm:mt-0`}
        >
          <a
            href={imageData.href}

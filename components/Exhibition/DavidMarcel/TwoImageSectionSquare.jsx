export default function TwoImageSection({ imageData }) {
  return (
    <div className="grid sm:grid-rows-2 grid-cols-1 sm:grid-cols-3 sm:grid-flow-col gap-6 max-w-7xl mx-10 sm:mx-auto pt-10">
      <div className="sm:col-span-2 sm:row-end-3 sm:row-span-2 flex flex-col sm:flex-row gap-4">
        <a href={imageData.href} className="flex flex-col-reverse sm:flex-row">
          <img
          ...
          <div className="flex flex-col justify-center sm:justify-end w-full ml-0 sm:ml-4 mt-2 sm:mt-0 pb-10 sm:pb-0">
            <p>{imageData.title}</p>

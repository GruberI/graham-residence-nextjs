          ...
          <Suspense>
            <div className="relative w-60 lg:w-96">
              <img
                ...
                className="object-cover object-center h-3/4 sm:ml-16 lg:ml-0"
              />
              <img
                src="
                ...
                className="absolute inset-0 object-cover object-center translate-x-44 sm:translate-x-64 lg:translate-x-80 translate-y-2/4 sm:h-3/4 h-3/4"
              />
            </div>
          </Suspense>

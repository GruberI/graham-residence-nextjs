...
<div className="mt-20 overflow-hidden sm:mt-20">
          <div className="mx-auto max-w-7xl px-6 lg:flex lg:px-8">
            <div className="mx-auto grid max-w-1xl grid-cols-1 gap-x-12 gap-y-16 lg:mx-0 lg:min-w-full lg:max-w-none lg:flex-none lg:gap-y-8">
              <div className="lg:col-end-1 lg:w-full lg:max-w-lg flex flex-col justify-center lg:pb-20 pl-20">
                <p className="mt-20 text-1xl leading-8 flex justify-center">
                  Come stay at
                </p>
                <p className="font-medium mt-2 text-3xl leading-8 flex justify-center"> THE GRAHAM RESIDENCE</p>
                <a
                  href="https://www.airbnb.com/rooms/18312865?source_impression_id=p3_1697958503_wgsynyWLg4S60ges"
                  className="p-2 text-black hover:text-black-500 pt-6"
                >
                  <button
                    type="submit"
                ...
                <div className="contents lg:col-span-2 lg:col-end-2 lg:ml-auto lg:flex lg:w-[37rem] lg:items-start lg:justify-end lg:gap-x-8">
                  <div className="order-first flex w-64 flex-none justify-end self-end lg:w-auto">
                    <img
                      ...
                      alt=""
                      className="aspect-[5/5] w-[24rem] max-w-none flex-none -2xl bg-gray-50 object-cover"
                    />
                  </div>
                  <div className="flex w-96 flex-auto justify-end lg:w-auto lg:flex-none">
                    <img
                      ...
                      alt=""
                      className="aspect-[7/5] w-[37rem] max-w-none flex-none -2xl bg-gray-50 object-cover"
                    />
                  </div>
                  <div className="hidden sm:block sm:w-0 sm:flex-auto lg:w-auto lg:flex-none">
                    <img
                      ...
                      alt=""
                      className="aspect-[4/3] w-[24rem] max-w-none 2xl bg-gray-50 object-cover"
                    />
                  </div>
                  </div>
                </div>
